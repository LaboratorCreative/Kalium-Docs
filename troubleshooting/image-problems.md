...
**Each area has its own Image Size setting** — blog, portfolio, search results, product navigation, the lightbox. Find the one for the area you're looking at.
...
**Customize -> General -> Lightbox Settings -> Main Image** — change it from *Full Size* to *Large*.
...
**Customize -> Performance -> JPEG Image Quality** — raise it, then regenerate your thumbnails.
