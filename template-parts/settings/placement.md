...
**Nothing appears at all.** Placement decides *where*, conditions decide *whether*. A Section with a placement but no display conditions is never shown on any page.
