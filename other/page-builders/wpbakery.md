...
| **Portfolio Item**    | One project within a Masonry Portfolio |
...
| **Placeholder**                       | An empty slot inside a Team Members grid |
...
{% hint style="info" %}
Several elements only go inside a container. **Team Member** and **Placeholder** belong in **Team Members**, **Portfolio Item** in **Masonry Portfolio**, **Client Logo** in **Clients**, **Service Content** in **Service Box**, and **Map Location** in **Map**. Add the container first, then the items inside it.
{% endhint %}
...
The **Map** element needs a Google Maps API key before it will display anything. Add yours under **Appearance -> Customize -> General -> Integrations**.
...
Add a Google Maps API key under **Appearance -> Customize -> General -> Integrations**.
