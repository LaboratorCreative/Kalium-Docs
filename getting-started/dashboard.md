...
Everything Kalium adds to your admin lives under the **Kalium** menu.
...
{% content-ref url="installation/license-activation.md" %}
[license-activation.md](installation/license-activation.md)
{% endcontent-ref %}
...
{% content-ref url="installation/importing-a-starter-site.md" %}
[importing-a-starter-site.md](installation/importing-a-starter-site.md)
{% endcontent-ref %}
...
[installing-required-plugins.md](installation/installing-required-plugins.md)
{% endcontent-ref %}

#### Status

Your site's health check, and **the first screen to open when something isn't working**.

It shows your PHP version, memory limit, whether your license is active, and whether your server can reach the internet. Kalium needs **PHP 7.4 or newer** and **at least 128 MB of memory**.
...
What changed in each release. Worth a look before updating, and again if something behaves differently afterwards.

***

### If a screen is missing

Two things hide Kalium's screens, and neither is a fault:
